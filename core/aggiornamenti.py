...
FILE_VERSIONE = os.path.join("config", "versione_jarvis.json")
...
class AggiornamentiJarvis:
    ...
    def __init__(self):
        ...
        self.moduli = [
            "jarvis.py", "core/kernel.py", "core/config.py", "core/logger.py",
            "core/event_bus.py", "core/manager.py", "core/aggiornamenti.py",
            "core/stato.py", "core/sicurezza.py", "memoria/memoria.py",
            ...
            "interfaccia/hud.py", "personalita/personalita.py"
        ]

    def salva_versione(self):
        os.makedirs(os.path.dirname(FILE_VERSIONE), exist_ok=True)
