...
ApplicationWindow {
    ...
    // Ambient technical grid. No Canvas: everything is native Qt Quick items.
    ...
    Item {
        ...
        Rectangle {
            ...
            border.color: "#7ef8ff"; border.width: 2
            opacity: 0.9
        }
        Rectangle {
    ...
    // Target brackets around the core.
    Item {
        x: root.width / 2 - 205; y: 126; width: 410; height: 300
        Rectangle { x: 0; y: 0; width: 42; height: 1; color: "#54f4ff" }
        Rectangle { x: 0; y: 0; width: 1; height: 42; color: "#54f4ff" }
        Rectangle { x: 368; y: 0; width: 42; height: 1; color: "#54f4ff" }
        Rectangle { x: 409; y: 0; width: 1; height: 42; color: "#54f4ff" }
        Rectangle { x: 0; y: 299; width: 42; height: 1; color: "#176d84" }
        Rectangle { x: 0; y: 258; width: 1; height: 42; color: "#176d84" }
        Rectangle { x: 368; y: 299; width: 42; height: 1; color: "#176d84" }
        Rectangle { x: 409; y: 258; width: 1; height: 42; color: "#176d84" }
    }

    // Bottom command ribbon.
    Rectangle {
        x: 284; y: root.height - 84; width: root.width - 568; height: 60
        color: "#03131b"; border.color: "#0b5264"; border.width: 1
        Text { x: 14; y: 10; text: "COMMAND"; color: "#4fa7b7"; font.pixelSize: 7; font.bold: true }
        Text { x: 14; y: 25; width: parent.width - 28; text: root.commandText; color: "#d6f8fc"; font.pixelSize: 11; elide: Text.ElideRight }
        Rectangle { x: 14; y: 48; width: parent.width - 28; height: 2; color: "#082936" }
        Rectangle { x: 14; y: 48; width: (parent.width - 28) * root.activity; height: 2; color: "#54f4ff" }
    }

    Text { x: 282; y: root.height - 18; text: "HUD ENGINE // QT QUICK // HARDWARE ACCELERATED"; color: "#2d6572"; font.pixelSize: 7 }
    Text { anchors.right: parent.right; anchors.rightMargin: 282; y: root.height - 18; text: "SECURE LOCAL SESSION"; color: "#28a85b"; font.pixelSize: 7; font.bold: true }

    component Metric: Row {
        property string label: ""
        property string value: "--"
        width: 218; spacing: 6
        Text { width: 76; text: parent.label; color: "#8ebfc8"; font.pixelSize: 8; font.bold: true }
        Rectangle { width: 105; height: 6; anchors.verticalCenter: parent.verticalCenter; color: "#061c25"; border.color: "#0a3a47"; border.width: 1
            Rectangle { width: 105 * Math.max(0, Math.min(1, Number(parent.parent.value) / 100)); height: 4; anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter; color: "#1d91b4" }
        }
        Text { width: 31; text: parent.value + "%"; color: "#54f4ff"; font.pixelSize: 8; font.bold: true; horizontalAlignment: Text.AlignRight }
    }

    component MatrixRow: Row {
        property string label: ""
        property string value: ""
        width: 194; spacing: 7
        Rectangle { width: 6; height: 6; radius: 3; color: "#28ee70"; anchors.verticalCenter: parent.verticalCenter }
        Text { width: 62; text: parent.label; color: "#8ebfc8"; font.pixelSize: 7 }
        Text { width: 115; text: parent.value; color: "#c7edf2"; font.pixelSize: 7; font.bold: true; horizontalAlignment: Text.AlignRight }
    }

    component DeviceRow: Row {
        property string label: ""
        property string state: "ONLINE"
        x: 22; width: 196; spacing: 8
        Rectangle { width: 6; height: 6; radius: 3; color: "#28ee70"; anchors.verticalCenter: parent.verticalCenter }
        Text { width: 100; text: parent.label; color: "#a8d2d9"; font.pixelSize: 7 }
        Text { width: 82; text: parent.state; color: "#28ee70"; font.pixelSize: 7; font.bold: true; horizontalAlignment: Text.AlignRight }
    }
}
